...
scale=.08, radius=64.1, length=266.96,
...
model = SasModel(data, GpuCoreShellCylinder,
                 scale=1, radius=64.1, thickness=1, length=266.96,
                 core_sld=1e-6, shell_sld=4e-6, solvent_sld=1e-6, background=0,
                 axis_theta=0, axis_phi=0,
                 radius_pd=0.1, radius_pd_n=1, radius_pd_nsigma=3,
                 length_pd=0.1, length_pd_n=1, length_pd_nsigma=3,
                 thickness_pd=0.1, thickness_pd_n=1, thickness_pd_nsigma=3,
                 axis_theta_pd=0.1, axis_theta_pd_n=1, axis_theta_pd_nsigma=3,
                 axis_phi_pd=0.1, axis_phi_pd_n=1, axis_phi_pd_nsigma=3,
                 dtype='float')
"""
"""
